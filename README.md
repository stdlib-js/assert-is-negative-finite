...
```javascript
isNegativeFinite = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-negative-finite@v0.1.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-negative-finite@v0.1.2-umd/browser.js"></script>
```
...
[@stdlib/assert/is-negative-number]: https://github.com/stdlib-js/assert-is-negative-number/tree/umd

[@stdlib/assert/is-positive-finite]: https://github.com/stdlib-js/assert-is-positive-finite/tree/umd
